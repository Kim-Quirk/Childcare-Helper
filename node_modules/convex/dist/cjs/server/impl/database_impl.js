...
function setupReader() {
  return {
    get: async (id) => {
      ...
      if (!(id instanceof import_values.GenericId)) {
        throw new Error(
          `Invalid argument \`id\` for \`db.get\` "${typeof id} ${id}`
        );
      }
      const args = { id: (0, import_values.convexToJson)(id) };
      const syscallJSON = await (0, import_syscall.performAsyncSyscall)("get", args);
...
function setupWriter() {
  ...
  return {
    ...
    insert: async (table, value) => {
      ...
      const syscallJSON = await (0, import_syscall.performAsyncSyscall)("insert", {
        table,
    ...
    patch: async (id, value) => {
      ...
      await (0, import_syscall.performAsyncSyscall)("update", {
    ...
    replace: async (id, value) => {
      ...
      await (0, import_syscall.performAsyncSyscall)("replace", {
        id: (0, import_values.convexToJson)(id),
        value: (0, import_values.convexToJson)(value)
      });
    },
    delete: async (id) => {
      ...
      await (0, import_syscall.performAsyncSyscall)("remove", { id: (0, import_values.convexToJson)(id) });
    }
  };
}
