...
function setupStorageReader(requestId) {
  return {
    getUrl: async (storageId) => {
      ...
      return await (0, import_syscall.performAsyncSyscall)("storageGetUrl", {
        requestId,
    ...
    getMetadata: async (storageId) => {
      return await (0, import_syscall.performAsyncSyscall)("storageGetMetadata", {
        requestId,
        version: import__.version,
        storageId
      });
...
function setupStorageWriter(requestId) {
  ...
  return {
    generateUploadUrl: async () => {
      return await (0, import_syscall.performAsyncSyscall)("storageGenerateUploadUrl", {
        requestId,
        version: import__.version
      });
    },
    delete: async (storageId) => {
      await (0, import_syscall.performAsyncSyscall)("storageDelete", {
        requestId,
        version: import__.version,
        storageId
      });
