...
const deploy = new import_commander.Command("deploy").description("Deploy to a production deployment").option("-v, --verbose", "Show full listing of changes").option(
  "--dry-run",
...
).addOption(new import_commander.Option("--debug-bundle-path <path>").hideHelp()).addOption(new import_commander.Option("--debug").hideHelp()).addOption(new import_commander.Option("-y, --yes").hideHelp()).addOption(new import_commander.Option("--admin-key <adminKey>").hideHelp()).addOption(new import_commander.Option("--url <url>").hideHelp()).showHelpAfterError().action(async (cmdOptions) => {
