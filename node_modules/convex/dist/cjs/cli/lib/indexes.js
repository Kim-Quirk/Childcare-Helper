...
async function pushSchema(ctx, origin, adminKey, schemaDir, dryRun) {
  ...
  try {
    ...
    (0, import_context.logFailure)(
      ctx,
      import_chalk.default.red("Error: Unable to build run schema validation on", origin)
    );
...
async function waitForReadySchema(ctx, origin, adminKey, schemaId) {
  ...
  switch (result.data.schemaState.state) {
    ...
    case "overwritten":
      (0, import_context.logError)(ctx, import_chalk.default.red(`Schema was overwritten by another push.`));
