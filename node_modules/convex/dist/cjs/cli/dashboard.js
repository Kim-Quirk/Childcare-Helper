...
__export(dashboard_exports, {
  ...
  dashboardUrlForConfig: () => dashboardUrlForConfig
});
...
async function dashboardUrl(ctx, includeDeployment = true) {
...
async function dashboardUrlForConfig(projectConfig, includeDeployment = true) {
  ...
  return `${host}/t/${team}/${project}${includeDeployment ? `/${deployment}` : ""}`;
}
