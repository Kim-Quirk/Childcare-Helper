...
export const auth = new Command("auth").description("Modify the authentication config").option("-v, --verbose", "Show changes and prompt for confirmation").addCommand(list).addCommand(rm).addCommand(add);
