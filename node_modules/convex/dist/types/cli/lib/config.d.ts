...
export declare function configJSON(config: Config, adminKey: string, schemaId?: string): {
    config: {
        projectSlug: string;
        teamSlug: string;
        functions: string;
...
export declare function pushConfig(ctx: Context, config: Config, adminKey: string, url: string, schemaId?: string): Promise<void>;
declare type Files = {
    source: string;
    filename: string;
}[];
