...
export declare class Crons<API extends GenericAPI> {
    ...
    isCrons: true;
    constructor();
    /* Excluded from this release type: schedule */
    /**
...
export declare type PublicHttpAction = {
    ...
    isHttp: true;
    isRegistered?: true;
    /* Excluded from this release type: invokeHttpAction */
};
...
export declare type RegisteredAction<Visibility extends FunctionVisibility, Args extends ArgsArray, Output> = {
    ...
    isAction: true;
    isRegistered?: true;
    /* Excluded from this release type: invokeAction */
    /* Excluded from this release type: exportArgs */
