...
export declare type AdminAuthentication = {
    type: "Authenticate";
    tokenType: "Admin";
    value: string;
...
export declare type Authenticate = AdminAuthentication | {
    type: "Authenticate";
    tokenType: "User";
    value: string;
    baseVersion: IdentityVersion;
...
export declare type ClientMessage = Connect | Authenticate | QuerySetModification | MutationRequest | ActionRequest | Event;
/**
