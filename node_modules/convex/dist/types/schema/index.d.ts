 ...
 * @module
 */
import { AnyDataModel, GenericDataModel, GenericDocument, GenericTableIndexes, GenericTableSearchIndexes } from "../server/data_model.js";
...
export declare class TableDefinition<Document extends GenericDocument = GenericDocument, FieldPaths extends string = string, Indexes extends GenericTableIndexes = {}, SearchIndexes extends GenericTableSearchIndexes = {}> {
    ...
    export(): {
        ...
        documentType: {
            ...
            type: "literal";
            value: import("../values/value.js").JSONValue;
        } | {
            type: "id";
            tableName: string;
        } | {
